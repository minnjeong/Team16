...
## 맥 유저들 안되면 이거 주석으로 바꾸세요. 테스트용입니다. id, password 자기 리포지토리로 바꾸세요.
# ca = certifi.where()
# client = MongoClient("mongodb+srv://id:password@cluster16.b0dkofq.mongodb.net/?retryWrites=true&w=majority", tlsCAFile = ca)
